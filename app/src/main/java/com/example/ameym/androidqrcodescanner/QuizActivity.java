...
public class QuizActivity extends AppCompatActivity {
    ...
    TextView textViewQuestion, textQuestionNumber;
    ...
    public void viewFirst() {
        ...
        textQuestionNumber.setText("Question "+questionCounter+" out of 20");

        res = myDb.getAllData(1);questionCounter++;
    ...
    public void viewAll() {
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioButton.getText().toString().equals(saveForPrevious) && res.getCount() != 0) {
                    score++;
                }
